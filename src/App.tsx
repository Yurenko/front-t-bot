...
function App() {
  ...
  useEffect(() => {
    ...
    // Очищаємо кеш при запуску додатку
    websocketService.clearCache();
    console.log("🧹 Кеш очищено при запуску додатку");
  ...
  const handleRefresh = async () => {
    // Очищаємо кеш при ручному оновленні
    websocketService.clearCache();
    console.log("🧹 Кеш очищено при ручному оновленні");
